...
extern void print_book(Board *board, struct _AvlNode *book);
...
extern U32 get_book_move(Board *board, bool show_book, struct _AvlNode *book);
...
extern void book_learn(Board *board, int winner, struct _AvlNode **tree);
